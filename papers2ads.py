...
the metadata it collects is often incomplete, so that article bibliographies have to
often be curated by hand. Here is where papers2ads comes in. It will read the bibtex
file exported by papers and fetch the corresponding bibtex references from ADS and 
...
bibtex file as test.bib and then run:
